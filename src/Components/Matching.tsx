...
const Matching = () => {
  return (
    <div className="bg-[#DCD1E8] font-lato px-16 py-20 ">
      ...
      <div className="flex gap-40  bg-[#8E69B4] rounded-3xl p-6">
        <div>
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-5 rounded-xl bg-[#FFFFFF80] w-96 h-10 px-5">
              <FaStar className="text-2xl text-yellow-400 " />
              <h1 className="text-xl font-semibold">Top Rated Consultants</h1>
            </div>
            <div className="flex items-center gap-5 rounded-xl bg-[#FFFFFF80] w-96 h-10 px-5">
              <FiMic className="text-2xl text-[#007EAF] " />
              <h1 className="text-xl font-semibold">100% Privacy</h1>
            </div>
            <div className="flex items-center gap-5 rounded-xl bg-[#FFFFFF80] w-96 h-10 px-5">
          ...
          <div className="flex items-end justify-between">
            <div className="flex items-center justify-between px-5 text-white bg-[#3C2C4C] rounded-full w-60 h-16 ">
              <span className="text-lg">Check your Eligibility </span>
              <IoMdArrowForward className="text-2xl " />
            </div>
            <div className="text-white text-xl cursor-pointer relative left-40">Read more</div>
          </div>
        </div>
      </div>
    </div>
